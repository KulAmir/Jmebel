...
<template>
  ...
  <div class="about">
    <h2>Наш Блог</h2>
    <p>Мы ежедневно рассказываем о лучших проектах, вдохновляющих идеях и делимся важными событиями —
      <br>от производства до законченных интерьеров в нашей новостой ленте.
    </p>
    <div class="buttn_inst">
...
.buttn_inst button span {
  margin: 10px;
}

.buttn_inst button::before {
  position: absolute;
  top: 0;
  left: 0;
  right: 0;
...
.buttn_inst button:hover {
  color: #fff;
  border: 1px solid rgb(255, 0, 0);
}

.buttn_inst button:hover::before {
